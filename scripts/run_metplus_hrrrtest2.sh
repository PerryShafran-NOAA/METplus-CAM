...
#BSUB -J metplus_hrrr2test
#BSUB -o /gpfs/dell2/ptmp/Perry.Shafran/output/metplus_hrrr2test.out
#BSUB -e /gpfs/dell2/ptmp/Perry.Shafran/output/metplus_hrrr2test.out
#BSUB -q "dev"
#BSUB -P VERF-T2O
...
export MET_PLUS_TMP=/gpfs/dell2/ptmp/Perry.Shafran/metplus_hrrr2test
...
export MET_PLUS_STD=/gpfs/dell2/ptmp/Perry.Shafran/metplus_hrrr2test_$DATE
export MET_PLUS_TMP=/gpfs/dell2/ptmp/Perry.Shafran/metplus_hrrr2test_$DATE

mkdir -p $MET_PLUS_STD
cd $MET_PLUS_TMP

export model=hrrr2test
...
cat << EOF > ${model}.conf
[dir]
FCST_POINT_STAT_INPUT_DIR = /gpfs/hps/nco/ops/com/hrrr/prod
...
cp /gpfs/dell2/ptmp/Perry.Shafran/output/metplus_hrrr2test.out $MET_PLUS_STD/metplus_hrrr2test_$DATE.out
