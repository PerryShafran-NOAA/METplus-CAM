#PBS -N metplus_hiarw2
#PBS -j oe
#PBS -o /lfs/h2/emc/ptmp/perry.shafran/output/metplus_hiarw2.out
#PBS -e /lfs/h2/emc/ptmp/perry.shafran/output/metplus_hiarw2.out
#PBS -q "dev"
#PBS -A VERF-DEV
#PBS -S /bin/bash
...
export cycle=t00z
export MET_PLUS_TMP=/lfs/h2/emc/ptmp/perry.shafran/metplus_hiarw2
...
export MET_PLUS_STD=/lfs/h2/emc/ptmp/perry.shafran/metplus_hiarw2
...
[filename_templates]
FCST_POINT_STAT_INPUT_TEMPLATE = hiresw.{init?fmt=%Y%m%d}/hiresw.t{init?fmt=%2H}z.arw_5km.f{lead?fmt=%2H}.himem2.grib2
...
/gpfs/dell2/emc/verification/save/Perry.Shafran/aws/mv_load_to_aws.sh perry.shafran ${MET_PLUS_TMP}/stat/ ${MET_PLUS_TMP}/load_met_hiarw2.xml

cp /gpfs/dell2/ptmp/Perry.Shafran/output/metplus_hiarw2.out $MET_PLUS_STD/metplus_hiarw2_$DATE.out
