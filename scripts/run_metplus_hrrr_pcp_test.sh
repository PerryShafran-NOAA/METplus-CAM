...
#BSUB -J metplus_pcp_hrrr
#BSUB -o /gpfs/dell2/ptmp/Perry.Shafran/output/metplus_pcp_hrrr.out
#BSUB -e /gpfs/dell2/ptmp/Perry.Shafran/output/metplus_pcp_hrrr.out
#BSUB -q "dev"
#BSUB -P VERF-T2O
...
export MET_PLUS_TMP=/gpfs/dell2/ptmp/Perry.Shafran/metplus_pcp_hrrr
...
export MET_PLUS_STD=/gpfs/dell2/ptmp/Perry.Shafran/metplus_pcp_hrrr_$DATE
export MET_PLUS_TMP=/gpfs/dell2/ptmp/Perry.Shafran/metplus_pcp_hrrr_$DATE
...
export model_dir=/gpfs/hps/nco/ops/com/hrrr/prod
...
VALID_INCREMENT = 3H
[filename_templates]
FCST_PCP_COMBINE_INPUT_TEMPLATE = hrrr.{init?fmt=%Y%m%d}/conus/hrrr.t{init?fmt=%2H}z.wrfprsf{lead?fmt=%2H}.grib2
FCST_PCP_COMBINE_OUTPUT_TEMPLATE = ${DATE}/hrrr.t{init?fmt=%H}z.conus.f{lead?fmt=%HH}.a{level?fmt=%HH}h
GRID_STAT_OUTPUT_TEMPLATE = grid_stat/${model}
EOF
...
/gpfs/dell2/emc/verification/save/Perry.Shafran/aws/mv_load_to_aws.sh perry.shafran ${MET_PLUS_TMP}/stat/ ${MET_PLUS_TMP}/load_met_hrrr.xml

cp /gpfs/dell2/ptmp/Perry.Shafran/output/metplus_hrrr_pcp.out $MET_PLUS_STD/metplus_hrrr_$DATE.out
