#PBS -N metplus_fv3lamdax
#PBS -j oe
#PBS -o /lfs/h2/emc/ptmp/perry.shafran/output/metplus_fv3lamdax.out
#PBS -e /lfs/h2/emc/ptmp/perry.shafran/output/metplus_fv3lamdax.out
#PBS -q "dev"
#PBS -A VERF-DEV
#PBS -S /bin/bash
...
export cycle=t00z
export MET_PLUS_TMP=/lfs/h2/emc/ptmp/perry.shafran/metplus_fv3lamdax
...
export MET_PLUS_STD=/lfs/h2/emc/ptmp/perry.shafran/metplus_fv3lamdax

mkdir -p $MET_PLUS_STD

export model=fv3lamdax
...
POINT_STAT_CONFIG_FILE ={METPLUS_PARM_BASE}/met_config/PointStatConfig_cam
LEAD_SEQ_MAX = 60
MODEL = ${model1}
...
[filename_templates]
FCST_POINT_STAT_INPUT_TEMPLATE = fv3lamdax.{init?fmt=%Y%m%d}/{init?fmt=%2H}/fv3lam.t{init?fmt=%2H}z.conus.f{lead?fmt=%3H}.grib2
...
/gpfs/dell2/emc/verification/save/Perry.Shafran/aws/mv_load_to_aws.sh perry.shafran ${MET_PLUS_TMP}/stat/ ${MET_PLUS_TMP}/load_met_fv3lamdax.xml

cp /gpfs/dell2/ptmp/Perry.Shafran/output/metplus_fv3lamdax.out $MET_PLUS_STD/metplus_fv3lamdax_$DATE.out
