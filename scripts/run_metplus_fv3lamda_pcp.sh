...
#BSUB -J metplus_pcp_fv3lamda
#BSUB -o /gpfs/dell2/ptmp/Perry.Shafran/output/metplus_pcp_fv3lamda.out
#BSUB -e /gpfs/dell2/ptmp/Perry.Shafran/output/metplus_pcp_fv3lamda.out
#BSUB -q "dev"
#BSUB -P VERF-T2O
...
export temp=/gpfs/dell2/ptmp/Perry.Shafran/fv3lamda_date
...
export MET_PLUS_TMP=/gpfs/dell2/ptmp/Perry.Shafran/metplus_pcp_fv3lamda_$DATE
...
export MET_PLUS_STD=/gpfs/dell2/ptmp/Perry.Shafran/metplus_pcp_fv3lamda_$DATE

mkdir -p $MET_PLUS_STD

export model=fv3lamda
model1=`echo $model | tr a-z A-Z`
echo $model1

export model_dir=/gpfs/dell5/ptmp/emc.campara/fv3lamda
...
export acc=1hr
export fhr_list="begin_end_incr(0,60,1)"
...
MODEL = ${model1}
LEAD_SEQ = begin_end_incr(0,60,3)
VALID_INCREMENT = 3H
[filename_templates]
FCST_GRID_STAT_INPUT_TEMPLATE = fv3lamda.{init?fmt=%Y%m%d}/{init?fmt=%2H}/fv3lam.t{init?fmt=%2H}z.conus.f{lead?fmt=%2H}.grib2
...
VALID_INCREMENT = 3H
[filename_templates]
FCST_PCP_COMBINE_INPUT_TEMPLATE = fv3lamda.{init?fmt=%Y%m%d}/{init?fmt=%2H}/fv3lam.t{init?fmt=%2H}z.conus.f{lead?fmt=%2H}.grib2
FCST_PCP_COMBINE_OUTPUT_TEMPLATE = ${DATE}/fv3lamda.t{init?fmt=%H}z.conus.f{lead?fmt=%HH}.a{level?fmt=%HH}h
GRID_STAT_OUTPUT_TEMPLATE = grid_stat/${model}
EOF
...
/gpfs/dell2/emc/verification/save/Perry.Shafran/aws/mv_load_to_aws.sh perry.shafran ${MET_PLUS_TMP}/stat/ ${MET_PLUS_TMP}/load_met_fv3lamda.xml

cp /gpfs/dell2/ptmp/Perry.Shafran/output/metplus_fv3lamda_pcp.out $MET_PLUS_STD/metplus_fv3lamda_$DATE.out
