...
export MET_PLUS_TMP=/gpfs/dell2/ptmp/Perry.Shafran/metplus_href
...
export MET_PLUS_STD=/gpfs/dell2/ptmp/Perry.Shafran/metplus_href
...
LEAD_SEQ = begin_end_incr(0,36,1)
MODEL = ${model1}
[filename_templates]
FCST_POINT_STAT_INPUT_TEMPLATE = href.{init?fmt=%Y%m%d}/ensprod/href.t{init?fmt=%2H}z.conus.mean.f{lead?fmt=%2H}.grib2
...
/gpfs/dell2/emc/verification/save/Perry.Shafran/aws/mv_load_to_aws.sh perry.shafran ${MET_PLUS_TMP}/stat/ ${MET_PLUS_TMP}/load_met_href.xml

cp /gpfs/dell2/ptmp/Perry.Shafran/output/metplus_href.out $MET_PLUS_STD/metplus_href_$DATE.out
