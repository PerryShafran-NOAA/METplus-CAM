#PBS -N metplus_conusfv3
#PBS -j oe
#PBS -o /lfs/h2/emc/ptmp/perry.shafran/output/metplus_conusfv3.out
#PBS -e /lfs/h2/emc/ptmp/perry.shafran/output/metplus_conusfv3.out
#PBS -q "dev"
#PBS -A VERF-DEV
#PBS -S /bin/bash
...
export MET_PLUS_TMP=/lfs/h2/emc/ptmp/perry.shafran/metplus_conusfv3
...
export MET_PLUS_STD=/lfs/h2/emc/ptmp/perry.shafran/metplus_conusfv3
...
MODEL = ${model1}
[filename_templates]
FCST_POINT_STAT_INPUT_TEMPLATE = hiresw.{init?fmt=%Y%m%d}/hiresw.t{init?fmt=%2H}z.fv3_5km.f{lead?fmt=%2H}.conus.grib2
