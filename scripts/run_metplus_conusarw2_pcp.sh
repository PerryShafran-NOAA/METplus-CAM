...
#BSUB -J metplus_pcp_conusarw2
#BSUB -o /gpfs/dell2/ptmp/Perry.Shafran/output/metplus_pcp_conusarw2.out
#BSUB -e /gpfs/dell2/ptmp/Perry.Shafran/output/metplus_pcp_conusarw2.out
#BSUB -q "dev"
#BSUB -P VERF-T2O
...
export MET_PLUS_TMP=/gpfs/dell2/ptmp/Perry.Shafran/metplus_pcp_conusarw2
...
export MET_PLUS_STD=/gpfs/dell2/ptmp/Perry.Shafran/metplus_pcp_conusarw2
...
VALID_INCREMENT = 3H
[filename_templates]
FCST_GRID_STAT_INPUT_TEMPLATE = hiresw.{init?fmt=%Y%m%d}/hiresw.t{init?fmt=%2H}z.arw_5km.f{lead?fmt=%2H}.conusmem2.grib2
...
FCST_PCP_COMBINE_INPUT_TEMPLATE = hiresw.{init?fmt=%Y%m%d}/hiresw.t{init?fmt=%2H}z.arw_5km.f{lead?fmt=%2H}.conusmem2.grib2
FCST_PCP_COMBINE_OUTPUT_TEMPLATE = ${DATE}/conusarw2.t{init?fmt=%H}z.conus.f{lead?fmt=%HH}.a{level?fmt=%HH}h
GRID_STAT_OUTPUT_TEMPLATE = grid_stat/${model}
EOF
...
/gpfs/dell2/emc/verification/save/Perry.Shafran/aws/mv_load_to_aws.sh perry.shafran ${MET_PLUS_TMP}/stat/ ${MET_PLUS_TMP}/load_met_conusarw2.xml

cp /gpfs/dell2/ptmp/Perry.Shafran/output/metplus_conusarw2_pcp.out $MET_PLUS_STD/metplus_conusarw2_$DATE.out
