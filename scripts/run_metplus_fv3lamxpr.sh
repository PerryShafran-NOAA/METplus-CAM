...
#BSUB -J metplus_fv3lamxpr
#BSUB -o /gpfs/dell2/ptmp/Perry.Shafran/output/metplus_fv3lamxpr.out
#BSUB -e /gpfs/dell2/ptmp/Perry.Shafran/output/metplus_fv3lamxpr.out
#BSUB -q "dev"
#BSUB -P VERF-T2O
...
export MET_PLUS_TMP=/gpfs/dell2/ptmp/Perry.Shafran/metplus_fv3lamxpr
...
export MET_PLUS_STD=/gpfs/dell2/ptmp/Perry.Shafran/metplus_fv3lamxpr

mkdir -p $MET_PLUS_STD

export model=fv3lamxpr
...
[filename_templates]
FCST_POINT_STAT_INPUT_TEMPLATE = fv3lamx.{init?fmt=%Y%m%d}/{init?fmt=%2H}/fv3lam.t{init?fmt=%2H}z.pr.f{lead?fmt=%2H}.grib2
