...
mkdir -p /lfs/h2/emc/vpppg/noscrub/perry.shafran/GOES16_AOD_HRRR_REGRID/${DATE}
...
export REF_FILE=/lfs/h1/ops/prod/com/hrrr/v4.1/hrrr.$DATE/conus/hrrr.t00z.wrfprsf00.grib2
...
EOF
    ...
    run_metplus.py -c  ${MET_PLUS_CONF}/point2grid_goes_aod_hrrr.conf ${MET_PLUS_TMP}/p2g.conf
    ((ohr++))
    echo $ohr
...
run_metplus.py -c ${MET_PLUS_CONF}/grid_stat_hrrr_goes_aod.conf ${MET_PLUS_TMP}/grid_stat.conf 
