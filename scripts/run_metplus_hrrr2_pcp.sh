...
#BSUB -J metplus_pcp_hrrr2
#BSUB -o /gpfs/dell2/ptmp/Perry.Shafran/output/metplus_pcp_hrrr2.out
#BSUB -e /gpfs/dell2/ptmp/Perry.Shafran/output/metplus_pcp_hrrr2.out
#BSUB -q "dev"
#BSUB -P VERF-T2O
...
export temp=/gpfs/dell2/ptmp/Perry.Shafran/metplus_pcp_hrrr2
...
export MET_PLUS_TMP=/gpfs/dell2/ptmp/Perry.Shafran/metplus_pcp_hrrr2_$DATE
...
export MET_PLUS_STD=/gpfs/dell2/ptmp/Perry.Shafran/metplus_pcp_hrrr2_$DATE
...
<load_spec>
  <connection>
    ...
    <database>mv_emc_lam_pcp_met</database>
    <user>rds_user</user>
...
cp /gpfs/dell2/ptmp/Perry.Shafran/output/metplus_hrrr2_pcp.out $MET_PLUS_STD/metplus_hrrr_$DATE.out
