...
#BSUB -J metplus_pcp_gfs
#BSUB -o /gpfs/dell2/ptmp/Perry.Shafran/output/metplus_pcp_gfs.out
#BSUB -e /gpfs/dell2/ptmp/Perry.Shafran/output/metplus_pcp_gfs.out
#BSUB -q "dev"
#BSUB -P VERF-T2O
...
VALID_INCREMENT = 3H
[filename_templates]
FCST_GRID_STAT_INPUT_TEMPLATE = gfs.{init?fmt=%Y%m%d}/{init?fmt=%2H}/atmos/gfs.t{init?fmt=%2H}z.pgrb2.0p25.f{lead?fmt=%3H}
...
FCST_PCP_COMBINE_INPUT_TEMPLATE = gfs.{init?fmt=%Y%m%d}/{init?fmt=%2H}/atmos/gfs.t{init?fmt=%2H}z.pgrb2.0p25.f{lead?fmt=%3H}
