#PBS -N metplus_conusarw
#PBS -j oe
#PBS -o /lfs/h2/emc/ptmp/perry.shafran/output/metplus_conusarw.out
#PBS -e /lfs/h2/emc/ptmp/perry.shafran/output/metplus_conusarw.out
#PBS -q "dev"
#PBS -A VERF-DEV
#PBS -S /bin/bash
...
export MET_PLUS_TMP=/lfs/h2/emc/ptmp/perry.shafran/metplus_conusarw
...
export MET_PLUS_STD=/lfs/h2/emc/ptmp/perry.shafran/metplus_conusarw
...
MODEL = ${model1}
[filename_templates]
FCST_POINT_STAT_INPUT_TEMPLATE = hiresw.{init?fmt=%Y%m%d}/hiresw.t{init?fmt=%2H}z.arw_5km.f{lead?fmt=%2H}.conus.grib2
