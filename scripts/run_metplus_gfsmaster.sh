...
#BSUB -J metplus_gfsmaster
#BSUB -o /gpfs/dell2/ptmp/Perry.Shafran/output/metplus_gfsmaster.o%J
#BSUB -e /gpfs/dell2/ptmp/Perry.Shafran/output/metplus_gfsmaster.o%J
#BSUB -q "dev"
#BSUB -P VERF-T2O
...
export MET_PLUS_TMP=/gpfs/dell2/ptmp/Perry.Shafran/metplus_gfsmaster
...
export MET_PLUS_STD=/gpfs/dell2/ptmp/Perry.Shafran/metplus_gfsmaster

mkdir -p $MET_PLUS_STD

export model=gfsmaster
...
cat << EOF > ${model}.conf
[dir]
FCST_POINT_STAT_INPUT_DIR = /gpfs/dell1/nco/ops/com/gfs/prod
...
MODEL = ${model1}
[filename_templates]
FCST_POINT_STAT_INPUT_TEMPLATE = gfs.{init?fmt=%Y%m%d}/{init?fmt=%2H}/gfs.t{init?fmt=%2H}z.master.grb2f{lead?fmt=%3H}
...
cp /gpfs/dell2/ptmp/Perry.Shafran/output/metplus_gfsmaster.out $MET_PLUS_STD/metplus_gfsmaster_$DATE.out
