...
#BSUB -J metplus_akrtmages
#BSUB -o /gpfs/dell2/ptmp/Perry.Shafran/output/metplus_akrtmages.o%J
#BSUB -e /gpfs/dell2/ptmp/Perry.Shafran/output/metplus_akrtmages.o%J
#BSUB -q "dev2"
#BSUB -P VERF-T2O
...
export MET_PLUS_TMP=/gpfs/dell2/ptmp/Perry.Shafran/metplus_akrtmages
...
export MET_PLUS_STD=/gpfs/dell2/ptmp/Perry.Shafran/metplus_akrtmages_${DATE}

mkdir -p $MET_PLUS_STD

export model=akrtmages
...
[filename_templates]
FCST_POINT_STAT_INPUT_TEMPLATE = akrtma.{init?fmt=%Y%m%d}/akrtma.t{init?fmt=%2H}z.2dvarges_ndfd.grb2
