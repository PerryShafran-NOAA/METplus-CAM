#PBS -N metplus_akfv3
#PBS -j oe
#PBS -o /lfs/h2/emc/ptmp/perry.shafran/output/metplus_akfv3.out
#PBS -e /lfs/h2/emc/ptmp/perry.shafran/output/metplus_akfv3.out
#PBS -q "dev"
#PBS -A VERF-DEV
#PBS -S /bin/bash
...
export cycle=t00z
export MET_PLUS_TMP=/lfs/h2/emc/ptmp/perry.shafran/metplus_akfv3
...
export MET_PLUS_STD=/lfs/h2/emc/ptmp/perry.shafran/metplus_akfv3
...
[filename_templates]
FCST_POINT_STAT_INPUT_TEMPLATE = hiresw.{init?fmt=%Y%m%d}/hiresw.t{init?fmt=%2H}z.fv3_5km.f{lead?fmt=%2H}.ak.grib2
