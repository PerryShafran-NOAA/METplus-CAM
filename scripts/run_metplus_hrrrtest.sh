...
#BSUB -J metplus_hrrr1test
#BSUB -o /gpfs/dell2/ptmp/Perry.Shafran/output/metplus_hrrr1test.out
#BSUB -e /gpfs/dell2/ptmp/Perry.Shafran/output/metplus_hrrr1test.out
#BSUB -q "dev"
#BSUB -P VERF-T2O
...
export MET_PLUS_TMP=/gpfs/dell2/ptmp/Perry.Shafran/metplus_hrrr1test
...
export MET_PLUS_STD=/gpfs/dell2/ptmp/Perry.Shafran/metplus_hrrr1test_$DATE
export MET_PLUS_TMP=/gpfs/dell2/ptmp/Perry.Shafran/metplus_hrrr1test_$DATE

mkdir -p $MET_PLUS_STD
cd $MET_PLUS_TMP

export model=hrrr1test
...
cp /gpfs/dell2/ptmp/Perry.Shafran/output/metplus_hrrr1test.out $MET_PLUS_STD/metplus_hrrr1test_$DATE.out
