#PBS -N metplus_prfv3
#PBS -j oe
#PBS -o /lfs/h2/emc/ptmp/perry.shafran/output/metplus_prfv3.out
#PBS -e /lfs/h2/emc/ptmp/perry.shafran/output/metplus_prfv3.out
#PBS -q "dev"
#PBS -A VERF-DEV
#PBS -S /bin/bash
...
export cycle=t00z
export MET_PLUS_TMP=/lfs/h2/emc/ptmp/perry.shafran/metplus_prfv3
...
export MET_PLUS_STD=/lfs/h2/emc/ptmp/perry.shafran/metplus_prfv3
...
[filename_templates]
FCST_POINT_STAT_INPUT_TEMPLATE = hiresw.{init?fmt=%Y%m%d}/hiresw.t{init?fmt=%2H}z.fv3_5km.f{lead?fmt=%2H}.pr.grib2
...
/gpfs/dell2/emc/verification/save/Perry.Shafran/aws/mv_load_to_aws.sh perry.shafran ${MET_PLUS_TMP}/stat/ ${MET_PLUS_TMP}/load_met_prfv3.xml

cp /gpfs/dell2/ptmp/Perry.Shafran/output/metplus_prfv3.out $MET_PLUS_STD/metplus_prfv3_$DATE.out
