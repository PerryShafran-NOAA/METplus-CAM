...
#BSUB -J metplus_fv3lamak
#BSUB -o /gpfs/dell2/ptmp/Perry.Shafran/output/metplus_fv3lamak.out
#BSUB -e /gpfs/dell2/ptmp/Perry.Shafran/output/metplus_fv3lamak.out
#BSUB -q "dev"
#BSUB -P VERF-T2O
...
export MET_PLUS_TMP=/gpfs/dell2/ptmp/Perry.Shafran/metplus_fv3lamak
...
export MET_PLUS_STD=/gpfs/dell2/ptmp/Perry.Shafran/metplus_fv3lamak_$DATE

mkdir -p $MET_PLUS_STD

export model=fv3lamak
...
POINT_STAT_CONFIG_FILE ={PARM_BASE}/met_config/PointStatConfig_cam_ak
...
/gpfs/dell2/emc/verification/save/Perry.Shafran/aws/mv_load_to_aws.sh perry.shafran ${MET_PLUS_TMP}/stat/ ${MET_PLUS_TMP}/load_met_fv3lamak.xml
