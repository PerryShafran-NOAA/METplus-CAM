#PBS -N metplus_rap
#PBS -j oe
#PBS -o /lfs/h2/emc/ptmp/perry.shafran/output/metplus_rap.out
#PBS -e /lfs/h2/emc/ptmp/perry.shafran/output/metplus_rap.out
#PBS -q "dev"
#PBS -A VERF-DEV
#PBS -S /bin/bash
...
export MET_PLUS_TMP=/lfs/h2/emc/ptmp/perry.shafran/metplus_rap
...
export MET_PLUS_STD=/lfs/h2/emc/ptmp/perry.shafran/metplus_rap
...
[filename_templates]
FCST_POINT_STAT_INPUT_TEMPLATE = rap.{init?fmt=%Y%m%d}/rap.t{init?fmt=%2H}z.awp130pgrbf{lead?fmt=%2H}.grib2
