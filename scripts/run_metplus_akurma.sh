...
#BSUB -J metplus_akurma
#BSUB -o /gpfs/dell2/ptmp/Perry.Shafran/output/metplus_akurma.o%J
#BSUB -e /gpfs/dell2/ptmp/Perry.Shafran/output/metplus_akurma.o%J
#BSUB -q "dev2"
#BSUB -P VERF-T2O
...
export MET_PLUS_TMP=/gpfs/dell2/ptmp/Perry.Shafran/metplus_akurma
...
export MET_PLUS_STD=/gpfs/dell2/ptmp/Perry.Shafran/metplus_akurma_${DATE}
...
[filename_templates]
FCST_POINT_STAT_INPUT_TEMPLATE = akurma.{init?fmt=%Y%m%d}/akurma.t{init?fmt=%2H}z.2dvaranl_ndfd.grb2
