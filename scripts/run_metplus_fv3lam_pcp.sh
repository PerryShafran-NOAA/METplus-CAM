...
export temp=/gpfs/dell2/ptmp/Perry.Shafran/fv3lam_date
...
export MET_PLUS_TMP=/gpfs/dell2/ptmp/Perry.Shafran/metplus_pcp_fv3lam_$DATE
...
export MET_PLUS_STD=/gpfs/dell2/ptmp/Perry.Shafran/metplus_pcp_fv3lam_$DATE
...
FCST_PCP_COMBINE_OUTPUT_TEMPLATE = ${DATE}/fv3lam.t{init?fmt=%H}z.conus.f{lead?fmt=%HH}.a{level?fmt=%HH}h
GRID_STAT_OUTPUT_TEMPLATE = grid_stat/${model}
EOF
