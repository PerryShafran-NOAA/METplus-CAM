...
#BSUB -J metplus_hirtmages
#BSUB -o /gpfs/dell2/ptmp/Perry.Shafran/output/metplus_hirtmages.o%J
#BSUB -e /gpfs/dell2/ptmp/Perry.Shafran/output/metplus_hirtmages.o%J
#BSUB -q "dev2"
#BSUB -P VERF-T2O
...
export MET_PLUS_TMP=/gpfs/dell2/ptmp/Perry.Shafran/metplus_hirtmages
...
export MET_PLUS_STD=/gpfs/dell2/ptmp/Perry.Shafran/metplus_hirtmages_${DATE}

mkdir -p $MET_PLUS_STD

export model=hirtmages
...
[filename_templates]
FCST_POINT_STAT_INPUT_TEMPLATE = hirtma.{init?fmt=%Y%m%d}/hirtma.t{init?fmt=%2H}z.2dvarges_ndfd.grb2
