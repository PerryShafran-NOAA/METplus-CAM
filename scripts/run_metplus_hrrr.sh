#PBS -N metplus_hrrr
#PBS -j oe
#PBS -o /lfs/h2/emc/ptmp/perry.shafran/output/metplus_hrrr.out
#PBS -e /lfs/h2/emc/ptmp/perry.shafran/output/metplus_hrrr.out
#PBS -q "dev"
#PBS -A VERF-DEV
#PBS -S /bin/bash
...
export MET_PLUS_TMP=/lfs/h2/emc/ptmp/perry.shafran/metplus_hrrr
...
export MET_PLUS_STD=/lfs/h2/emc/ptmp/perry.shafran/metplus_hrrr
#export MET_PLUS_TMP=/lfs/h2/emc/ptmp/perry.shafran/metplus_hrrr_$DATE
