...
#BSUB -J metplus_rtma-ruges
#BSUB -o /gpfs/dell2/ptmp/Perry.Shafran/output/metplus_rtma-ruges.o%J
#BSUB -e /gpfs/dell2/ptmp/Perry.Shafran/output/metplus_rtma-ruges.o%J
#BSUB -q "dev2"
#BSUB -P VERF-T2O
...
export MET_PLUS_TMP=/gpfs/dell2/ptmp/Perry.Shafran/metplus_rtma-ruges
...
export MET_PLUS_STD=/gpfs/dell2/ptmp/Perry.Shafran/metplus_rtma-ruges_${DATE}

mkdir -p $MET_PLUS_STD

export model=rtma-ruges
...
MODEL = ${model1}
[filename_templates]
FCST_POINT_STAT_INPUT_TEMPLATE = rtma2p5_ru.{init?fmt=%Y%m%d}/rtma2p5_ru.t{init?fmt=%2H}00z.2dvarges_ndfd.grb2
