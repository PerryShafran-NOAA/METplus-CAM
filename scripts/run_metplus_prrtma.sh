...
#BSUB -J metplus_prrtma
#BSUB -o /gpfs/dell2/ptmp/Perry.Shafran/output/metplus_prrtma.o%J
#BSUB -e /gpfs/dell2/ptmp/Perry.Shafran/output/metplus_prrtma.o%J
#BSUB -q "dev2"
#BSUB -P VERF-T2O
...
export MET_PLUS_TMP=/gpfs/dell2/ptmp/Perry.Shafran/metplus_prrtma
...
export MET_PLUS_STD=/gpfs/dell2/ptmp/Perry.Shafran/metplus_prrtma_${DATE}
...
[filename_templates]
FCST_POINT_STAT_INPUT_TEMPLATE = prrtma.{init?fmt=%Y%m%d}/prrtma.t{init?fmt=%2H}z.2dvaranl_ndfd.grb2
