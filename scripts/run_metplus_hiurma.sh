...
#BSUB -J metplus_hiurma
#BSUB -o /gpfs/dell2/ptmp/Perry.Shafran/output/metplus_hiurma.o%J
#BSUB -e /gpfs/dell2/ptmp/Perry.Shafran/output/metplus_hiurma.o%J
#BSUB -q "dev2"
#BSUB -P VERF-T2O
...
export MET_PLUS_TMP=/gpfs/dell2/ptmp/Perry.Shafran/metplus_hiurma
...
export MET_PLUS_STD=/gpfs/dell2/ptmp/Perry.Shafran/metplus_hiurma_${DATE}
...
[filename_templates]
FCST_POINT_STAT_INPUT_TEMPLATE = hiurma.{init?fmt=%Y%m%d}/hiurma.t{init?fmt=%2H}z.2dvaranl_ndfd.grb2
