...
#BSUB -o /gpfs/dell2/ptmp/Perry.Shafran/output/metplus_pcp_fv3lam.out
#BSUB -e /gpfs/dell2/ptmp/Perry.Shafran/output/metplus_pcp_fv3lam.out
#BSUB -q "dev"
#BSUB -P VERF-T2O
...
export temp=/gpfs/dell2/ptmp/Perry.Shafran/rrfscmaq_date
...
export MET_PLUS_TMP=/gpfs/dell2/ptmp/Perry.Shafran/metplus_pcp_rrfscmaq_$DATE
...
export MET_PLUS_STD=/gpfs/dell2/ptmp/Perry.Shafran/metplus_pcp_rrfscmaq_$DATE

mkdir -p $MET_PLUS_STD

export model=rrfscmaq
model1=`echo $model | tr a-z A-Z`
echo $model1

export model_dir=/gpfs/dell2/emc/retros/noscrub/Jianping.Huang/data/RRFSCMAQ/v141_a
...
export acc=6hr
export fhr_list="begin_end_incr(0,30,6)"
...
cp /gpfs/dell2/emc/verification/noscrub/Perry.Shafran/com/ccpa/prod/ccpa.$PDYm3/00/ccpa.*.06h.hrap.conus.gb2 /gpfs/dell2/ptmp/Perry.Shafran/ccpa/ccpa.$PDYm3
cp /gpfs/dell2/emc/verification/noscrub/Perry.Shafran/com/ccpa/prod/ccpa.$PDYm3/06/ccpa.*.06h.hrap.conus.gb2 /gpfs/dell2/ptmp/Perry.Shafran/ccpa/ccpa.$PDYm3
cp /gpfs/dell2/emc/verification/noscrub/Perry.Shafran/com/ccpa/prod/ccpa.$PDYm3/12/ccpa.*.06h.hrap.conus.gb2 /gpfs/dell2/ptmp/Perry.Shafran/ccpa/ccpa.$PDYm3
cp /gpfs/dell2/emc/verification/noscrub/Perry.Shafran/com/ccpa/prod/ccpa.$PDYm3/18/ccpa.*.06h.hrap.conus.gb2 /gpfs/dell2/ptmp/Perry.Shafran/ccpa/ccpa.$PDYm3
cp /gpfs/dell2/emc/verification/noscrub/Perry.Shafran/com/ccpa/prod/ccpa.$PDYm4/00/ccpa.t00z.06h.hrap.conus.gb2 /gpfs/dell2/ptmp/Perry.Shafran/ccpa/ccpa.$PDYm3

cp /gpfs/dell2/emc/verification/noscrub/Perry.Shafran/com/ccpa/prod/ccpa.$PDYm2/00/ccpa.*.06h.hrap.conus.gb2 /gpfs/dell2/ptmp/Perry.Shafran/ccpa/ccpa.$PDYm2
cp /gpfs/dell2/emc/verification/noscrub/Perry.Shafran/com/ccpa/prod/ccpa.$PDYm2/06/ccpa.*.06h.hrap.conus.gb2 /gpfs/dell2/ptmp/Perry.Shafran/ccpa/ccpa.$PDYm2
cp /gpfs/dell2/emc/verification/noscrub/Perry.Shafran/com/ccpa/prod/ccpa.$PDYm2/12/ccpa.*.06h.hrap.conus.gb2 /gpfs/dell2/ptmp/Perry.Shafran/ccpa/ccpa.$PDYm2
cp /gpfs/dell2/emc/verification/noscrub/Perry.Shafran/com/ccpa/prod/ccpa.$PDYm2/18/ccpa.*.06h.hrap.conus.gb2 /gpfs/dell2/ptmp/Perry.Shafran/ccpa/ccpa.$PDYm2
cp /gpfs/dell2/emc/verification/noscrub/Perry.Shafran/com/ccpa/prod/ccpa.$PDYm3/00/ccpa.t00z.06h.hrap.conus.gb2 /gpfs/dell2/ptmp/Perry.Shafran/ccpa/ccpa.$PDYm2
...
/gpfs/dell2/emc/verification/save/Perry.Shafran/aws/mv_load_to_aws.sh perry.shafran ${MET_PLUS_TMP}/stat/ ${MET_PLUS_TMP}/load_met_fv3lam.xml

cp /gpfs/dell2/ptmp/Perry.Shafran/output/metplus_fv3lam_pcp.out $MET_PLUS_STD/metplus_fv3lam_$DATE.out
