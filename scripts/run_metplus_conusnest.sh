#PBS -N metplus_conusnest
#PBS -j oe
#PBS -o /lfs/h2/emc/ptmp/perry.shafran/output/metplus_conusnest.out
#PBS -e /lfs/h2/emc/ptmp/perry.shafran/output/metplus_conusnest.out
#PBS -q "dev"
#PBS -A VERF-DEV
#PBS -S /bin/bash
...
export MET_PLUS_TMP=/lfs/h2/emc/ptmp/perry.shafran/metplus_conusnest
...
export MET_PLUS_STD=/lfs/h2/emc/ptmp/perry.shafran/metplus_conusnest
...
[filename_templates]
FCST_POINT_STAT_INPUT_TEMPLATE = nam.{init?fmt=%Y%m%d}/nam.t{init?fmt=%2H}z.conusnest.hiresf{lead?fmt=%2H}.tm00.grib2
