...
#BSUB -J metplus_conusnmmb
#BSUB -o /gpfs/dell2/ptmp/Perry.Shafran/output/metplus_conusnmmb.out
#BSUB -e /gpfs/dell2/ptmp/Perry.Shafran/output/metplus_conusnmmb.out
#BSUB -q "dev"
#BSUB -P VERF-T2O
...
export MET_PLUS_TMP=/gpfs/dell2/ptmp/Perry.Shafran/metplus_conusnmmb
...
export MET_PLUS_STD=/gpfs/dell2/ptmp/Perry.Shafran/metplus_conusnmmb
...
MODEL = ${model1}
[filename_templates]
FCST_POINT_STAT_INPUT_TEMPLATE = hiresw.{init?fmt=%Y%m%d}/hiresw.t{init?fmt=%2H}z.nmmb_5km.f{lead?fmt=%2H}.conus.grib2
...
cp /gpfs/dell2/ptmp/Perry.Shafran/output/metplus_conusnmmb.out $MET_PLUS_STD/metplus_conusnmmb_$DATE.out
