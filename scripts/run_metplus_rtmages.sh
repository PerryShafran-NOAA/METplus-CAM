#PBS -N metplus_rtmages
#PBS -j oe
#PBS -o /lfs/h2/emc/ptmp/perry.shafran/output/metplus_rtmages.out
#PBS -e /lfs/h2/emc/ptmp/perry.shafran/output/metplus_rtmages.out
#PBS -q "dev"
#PBS -A VERF-DEV
#PBS -S /bin/bash
...
export cycle=t00z
export MET_PLUS_TMP=/lfs/h2/emc/ptmp/perry.shafran/metplus_rtmages
...
export MET_PLUS_STD=/lfs/h2/emc/ptmp/perry.shafran/metplus_rtmages

mkdir -p $MET_PLUS_STD

export model=rtmages
...
MODEL = ${model1}
[filename_templates]
FCST_POINT_STAT_INPUT_TEMPLATE = rtma2p5.{init?fmt=%Y%m%d}/rtma2p5.t{init?fmt=%2H}z.2dvarges_ndfd.grb2
