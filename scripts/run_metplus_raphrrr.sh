...
export MET_PLUS_TMP=/stmpp1/Perry.Shafran/metplus_raphrrr
...
export MET_PLUS_STD=/ptmpp1/Perry.Shafran/metplus_raphrrr
...
for model in rap hrrr
do

${MET_PLUS}/ush/master_metplus.py -c ${MET_PLUS}/parm/use_cases/grid_to_obs/grid_to_obs.conf -c ${MET_PLUS}/parm/use_cases/grid_to_obs/examples/conus_surface.conf -c ${MET_PLUS_CONF}/pb2nc_raphrrr.conf -c ${MET_PLUS_CONF}/point_stat_${model}.conf -c ${MET_PLUS_TMP}/shared.conf -c ${MET_PLUS_CONF}/system_raphrrr.conf
...
cp /ptmpp2/Perry.Shafran/output/metplus_raphrrr.out $MET_PLUS_STD/metplus_raphrrr_$DATE.out
