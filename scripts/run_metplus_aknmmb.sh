...
#BSUB -J metplus_aknmmb
#BSUB -o /gpfs/dell2/ptmp/Perry.Shafran/output/metplus_aknmmb.out
#BSUB -e /gpfs/dell2/ptmp/Perry.Shafran/output/metplus_aknmmb.out
#BSUB -q "dev"
#BSUB -P VERF-T2O
...
export MET_PLUS_TMP=/gpfs/dell2/ptmp/Perry.Shafran/metplus_aknmmb
...
export MET_PLUS_STD=/gpfs/dell2/ptmp/Perry.Shafran/metplus_aknmmb
...
[filename_templates]
FCST_POINT_STAT_INPUT_TEMPLATE = hiresw.{init?fmt=%Y%m%d}/hiresw.t{init?fmt=%2H}z.nmmb_5km.f{lead?fmt=%2H}.ak.grib2
...
/gpfs/dell2/emc/verification/save/Perry.Shafran/aws/mv_load_to_aws.sh perry.shafran ${MET_PLUS_TMP}/stat/ ${MET_PLUS_TMP}/load_met_aknmmb.xml

cp /gpfs/dell2/ptmp/Perry.Shafran/output/metplus_aknmmb.out $MET_PLUS_STD/metplus_aknmmb_$DATE.out
