...
#BSUB -J metplus_hirtma
#BSUB -o /gpfs/dell2/ptmp/Perry.Shafran/output/metplus_hirtma.o%J
#BSUB -e /gpfs/dell2/ptmp/Perry.Shafran/output/metplus_hirtma.o%J
#BSUB -q "dev2"
#BSUB -P VERF-T2O
...
export MET_PLUS_TMP=/gpfs/dell2/ptmp/Perry.Shafran/metplus_hirtma
...
export MET_PLUS_STD=/gpfs/dell2/ptmp/Perry.Shafran/metplus_hirtma_${DATE}
...
[filename_templates]
FCST_POINT_STAT_INPUT_TEMPLATE = hirtma.{init?fmt=%Y%m%d}/hirtma.t{init?fmt=%2H}z.2dvaranl_ndfd.grb2
