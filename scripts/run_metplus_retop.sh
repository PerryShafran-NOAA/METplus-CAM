...
export MET_PLUS_STD=/gpfs/dell2/ptmp/Perry.Shafran/metplus_hrrr_retop
...
${MET_PLUS}/ush/master_metplus.py -c ${MET_PLUS_CONF}/system_mrms.conf -c ${MET_PLUS_CONF}/GridStat_fcstCAM_obsMRMS_RETOP.conf -c ${MET_PLUS_CONF}/${model}.conf
