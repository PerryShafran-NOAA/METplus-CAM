#PBS -N metplus_fv3lamdaxak
#PBS -j oe
#PBS -o /lfs/h2/emc/ptmp/perry.shafran/output/metplus_fv3lamdaxak.out
#PBS -e /lfs/h2/emc/ptmp/perry.shafran/output/metplus_fv3lamdaxak.out
#PBS -q "dev"
#PBS -A VERF-DEV
#PBS -S /bin/bash
...
export cycle=t00z
export MET_PLUS_TMP=/lfs/h2/emc/ptmp/perry.shafran/metplus_fv3lamdaxak
...
export MET_PLUS_STD=/lfs/h2/emc/ptmp/perry.shafran/metplus_fv3lamdaxak

mkdir -p $MET_PLUS_STD

export model=fv3lamdaxak
...
[filename_templates]
FCST_POINT_STAT_INPUT_TEMPLATE = fv3lamdax.{init?fmt=%Y%m%d}/{init?fmt=%2H}/fv3lam.t{init?fmt=%2H}z.ak.f{lead?fmt=%3H}.grib2
