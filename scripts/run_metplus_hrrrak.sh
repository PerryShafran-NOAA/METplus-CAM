#PBS -N metplus_hrrrak
#PBS -j oe
#PBS -o /lfs/h2/emc/ptmp/perry.shafran/output/metplus_hrrrak.out
#PBS -e /lfs/h2/emc/ptmp/perry.shafran/output/metplus_hrrrak.out
#PBS -q "dev"
#PBS -A VERF-DEV
#PBS -S /bin/bash
...
export cycle=t00z
export MET_PLUS_TMP=/lfs/h2/emc/ptmp/perry.shafran/metplus_hrrrak
...
export MET_PLUS_STD=/lfs/h2/emc/ptmp/perry.shafran/metplus_hrrrak
...
/gpfs/dell2/emc/verification/save/Perry.Shafran/aws/mv_load_to_aws.sh perry.shafran ${MET_PLUS_TMP}/stat/ ${MET_PLUS_TMP}/load_met_hrrrak.xml

cp /gpfs/dell2/ptmp/Perry.Shafran/output/metplus_hrrrak.out $MET_PLUS_STD/metplus_hrrrak_$DATE.out
