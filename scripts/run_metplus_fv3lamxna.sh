...
#BSUB -J metplus_fv3lamxna
#BSUB -o /gpfs/dell2/ptmp/Perry.Shafran/output/metplus_fv3lamxna.out
#BSUB -e /gpfs/dell2/ptmp/Perry.Shafran/output/metplus_fv3lamxna.out
#BSUB -q "dev"
#BSUB -P VERF-T2O
...
export MET_PLUS_TMP=/gpfs/dell2/ptmp/Perry.Shafran/metplus_fv3lamxna
...
export MET_PLUS_STD=/gpfs/dell2/ptmp/Perry.Shafran/metplus_fv3lamxna

mkdir -p $MET_PLUS_STD

export model=fv3lamxna
...
[filename_templates]
FCST_POINT_STAT_INPUT_TEMPLATE = fv3lamx.{init?fmt=%Y%m%d}/{init?fmt=%2H}/fv3lam.t{init?fmt=%2H}z.namerica.f{lead?fmt=%2H}.grib2
...
/gpfs/dell2/emc/verification/save/Perry.Shafran/aws/mv_load_to_aws.sh perry.shafran ${MET_PLUS_TMP}/stat/ ${MET_PLUS_TMP}/load_met_fv3lamxna.xml
