...
#BSUB -J metplus_urma
#BSUB -o /gpfs/dell2/ptmp/Perry.Shafran/output/metplus_urma.o%J
#BSUB -e /gpfs/dell2/ptmp/Perry.Shafran/output/metplus_urma.o%J
#BSUB -q "dev2"
#BSUB -P VERF-T2O
...
export MET_PLUS_TMP=/gpfs/dell2/ptmp/Perry.Shafran/metplus_urma
...
export MET_PLUS_STD=/gpfs/dell2/ptmp/Perry.Shafran/metplus_urma_${DATE}
...
MODEL = ${model1}
[filename_templates]
FCST_POINT_STAT_INPUT_TEMPLATE = urma2p5.{init?fmt=%Y%m%d}/urma2p5.t{init?fmt=%2H}z.2dvaranl_ndfd.grb2
