...
#BSUB -J metplus_pcp_rap
#BSUB -o /gpfs/dell2/ptmp/Perry.Shafran/output/metplus_pcp_rap.out
#BSUB -e /gpfs/dell2/ptmp/Perry.Shafran/output/metplus_pcp_rap.out
#BSUB -q "dev"
#BSUB -P VERF-T2O
...
export MET_PLUS_TMP=/gpfs/dell2/ptmp/Perry.Shafran/metplus_pcp_rap
...
export MET_PLUS_STD=/gpfs/dell2/ptmp/Perry.Shafran/metplus_pcp_rap
...
export model_dir=/gpfs/hps/nco/ops/com/rap/prod
...
export acc=1hr
export fhr_list="begin_end_incr(0,51,1)"
...
cp /gpfs/dell1/nco/ops/com/ccpa/prod/ccpa.$PDYm4/00/ccpa.*.01h.hrap.conus.gb2 /gpfs/dell2/ptmp/Perry.Shafran/ccpa/ccpa.$PDYm4
cp /gpfs/dell1/nco/ops/com/ccpa/prod/ccpa.$PDYm4/06/ccpa.*.01h.hrap.conus.gb2 /gpfs/dell2/ptmp/Perry.Shafran/ccpa/ccpa.$PDYm4
cp /gpfs/dell1/nco/ops/com/ccpa/prod/ccpa.$PDYm4/12/ccpa.*.01h.hrap.conus.gb2 /gpfs/dell2/ptmp/Perry.Shafran/ccpa/ccpa.$PDYm4
cp /gpfs/dell1/nco/ops/com/ccpa/prod/ccpa.$PDYm4/18/ccpa.*.01h.hrap.conus.gb2 /gpfs/dell2/ptmp/Perry.Shafran/ccpa/ccpa.$PDYm4
cp /gpfs/dell1/nco/ops/com/ccpa/prod/ccpa.$PDYm5/00/ccpa.t00z.01h.hrap.conus.gb2 /gpfs/dell2/ptmp/Perry.Shafran/ccpa/ccpa.$PDYm4
...
MODEL = ${model1}
LEAD_SEQ = begin_end_incr(0,51,3)
VALID_INCREMENT = 3H
[filename_templates]
FCST_GRID_STAT_INPUT_TEMPLATE = rap.{init?fmt=%Y%m%d}/rap.t{init?fmt=%2H}z.awp130pgrbf{lead?fmt=%2H}.grib2
...
VALID_INCREMENT = 3H
[filename_templates]
FCST_PCP_COMBINE_INPUT_TEMPLATE = rap.{init?fmt=%Y%m%d}/rap.t{init?fmt=%2H}z.awp130pgrbf{lead?fmt=%2H}.grib2
FCST_PCP_COMBINE_OUTPUT_TEMPLATE = ${DATE}/rap.t{init?fmt=%H}z.conus.f{lead?fmt=%HH}.a{level?fmt=%HH}h
GRID_STAT_OUTPUT_TEMPLATE = grid_stat/${model}
EOF
...
/gpfs/dell2/emc/verification/save/Perry.Shafran/aws/mv_load_to_aws.sh perry.shafran ${MET_PLUS_TMP}/stat/ ${MET_PLUS_TMP}/load_met_rap.xml

cp /gpfs/dell2/ptmp/Perry.Shafran/output/metplus_rap_pcp.out $MET_PLUS_STD/metplus_rap_$DATE.out
