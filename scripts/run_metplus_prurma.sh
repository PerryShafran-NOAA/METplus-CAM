...
#BSUB -J metplus_prurma
#BSUB -o /gpfs/dell2/ptmp/Perry.Shafran/output/metplus_prurma.o%J
#BSUB -e /gpfs/dell2/ptmp/Perry.Shafran/output/metplus_prurma.o%J
#BSUB -q "dev2"
#BSUB -P VERF-T2O
...
export MET_PLUS_TMP=/gpfs/dell2/ptmp/Perry.Shafran/metplus_prurma
...
export MET_PLUS_STD=/gpfs/dell2/ptmp/Perry.Shafran/metplus_prurma_${DATE}
...
[filename_templates]
FCST_POINT_STAT_INPUT_TEMPLATE = prurma.{init?fmt=%Y%m%d}/prurma.t{init?fmt=%2H}z.2dvaranl_ndfd.grb2
