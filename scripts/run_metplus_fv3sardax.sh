...
export MET_PLUS_TMP=/gpfs/dell2/ptmp/Perry.Shafran/metplus_fv3sardax
...
export MET_PLUS_STD=/gpfs/dell2/ptmp/Perry.Shafran/metplus_fv3sardax

mkdir -p $MET_PLUS_STD

export model=fv3sardax
...
cat << EOF > ${model}.conf
[dir]
FCST_POINT_STAT_INPUT_DIR = /gpfs/dell5/ptmp/Ting.Lei/com/fv3cam/EXP0GensColdStartBlendingRegion
...
MODEL = ${model1}
[filename_templates]
FCST_POINT_STAT_INPUT_TEMPLATE = fv3sar.{init?fmt=%Y%m%d}/{init?fmt=%2H}/fv3sar.t{init?fmt=%2H}z.conus.f{lead?fmt=%2H}.grib2
...
/gpfs/dell2/emc/verification/save/Perry.Shafran/aws/mv_load_to_aws.sh perry.shafran ${MET_PLUS_TMP}/stat/ ${MET_PLUS_TMP}/load_met_fv3sardax.xml

cp /gpfs/dell2/ptmp/Perry.Shafran/output/metplus_fv3sardax.out $MET_PLUS_STD/metplus_fv3sardax_$DATE.out
