...
#BSUB -J metplus_fv3lamdana
#BSUB -o /gpfs/dell2/ptmp/Perry.Shafran/output/metplus_fv3lamdana.o%J
#BSUB -e /gpfs/dell2/ptmp/Perry.Shafran/output/metplus_fv3lamdana.o%J
#BSUB -q "dev"
#BSUB -P VERF-T2O
...
export MET_PLUS_TMP=/gpfs/dell2/ptmp/Perry.Shafran/metplus_fv3lamdana
...
export MET_PLUS_STD=/gpfs/dell2/ptmp/Perry.Shafran/metplus_fv3lamdana_$DATE

mkdir -p $MET_PLUS_STD

export model=fv3lamdana
model1=`echo $model | tr a-z A-Z`
echo $model1

module use /gpfs/dell2/emc/verification/noscrub/emc.metplus/modulefiles/
module load met/g2c_test
...
cat << EOF > ${model}.conf
[dir]
FCST_POINT_STAT_INPUT_DIR = /gpfs/dell2/ptmp/emc.campara/fv3lamdax
OBS_POINT_STAT_INPUT_DIR = {OUTPUT_BASE}/cam/namerica_cam
[config]
METPLUS_CONF = {OUTPUT_BASE}/conf/${model}/metplus_final_pb2nc_pointstat.conf
POINT_STAT_CONFIG_FILE ={PARM_BASE}/met_config/PointStatConfig_cam_na
LEAD_SEQ = begin_end_incr(0,60,1)
MODEL = ${model1}
POINT_STAT_GRID = G221
...
[filename_templates]
FCST_POINT_STAT_INPUT_TEMPLATE = fv3lamdax.{init?fmt=%Y%m%d}/{init?fmt=%2H}/fv3lam.t{init?fmt=%2H}z.namerica.f{lead?fmt=%2H}.grib2
POINT_STAT_OUTPUT_TEMPLATE = ${model}
EOF

${MET_PLUS}/ush/master_metplus.py -c ${MET_PLUS}/parm/use_cases/grid_to_obs/grid_to_obs.conf -c ${MET_PLUS}/parm/use_cases/grid_to_obs/examples/conus_surface.conf -c ${MET_PLUS_CONF}/pb2nc_cam_na.conf -c ${MET_PLUS_CONF}/point_stat_cam.conf -c ${MET_PLUS_TMP}/${model}.conf -c ${MET_PLUS_CONF}/shared.conf -c ${MET_PLUS_TMP}/shared_${model}.conf -c ${MET_PLUS_CONF}/system_g2ctest.conf
...
/gpfs/dell2/emc/verification/save/Perry.Shafran/aws/mv_load_to_aws.sh perry.shafran ${MET_PLUS_TMP}/stat/ ${MET_PLUS_TMP}/load_met_fv3lamna.xml
