...
export MET_PLUS_TMP=/stmpp1/Perry.Shafran/metplus_raphrrrak
...
export MET_PLUS_OUT=/meso/noscrub/Perry.Shafran/metplus_raphrrr
export MET_PLUS_STD=/ptmpp1/Perry.Shafran/metplus_raphrrrak
...
for model in rapak hrrrak
do

${MET_PLUS}/ush/master_metplus.py -c ${MET_PLUS}/parm/use_cases/grid_to_obs/grid_to_obs.conf -c ${MET_PLUS}/parm/use_cases/grid_to_obs/examples/conus_surface.conf -c ${MET_PLUS_CONF}/pb2nc_raphrrr_ak.conf -c ${MET_PLUS_CONF}/point_stat_${model}.conf -c ${MET_PLUS_TMP}/shared.conf -c ${MET_PLUS_CONF}/system_raphrrr.conf
...
/meso/save/Perry.Shafran/aws/mv_load_to_aws.sh perry.shafran ${MET_PLUS_TMP}/stat/ /meso/save/Perry.Shafran/aws/load_met_raphrrr.xml

cp /ptmpp2/Perry.Shafran/output/metplus_raphrrrak.out $MET_PLUS_STD/metplus_raphrrrak_$DATE.out
