#PBS -N metplus_priconest
#PBS -j oe
#PBS -o /lfs/h2/emc/ptmp/perry.shafran/output/metplus_priconest.out
#PBS -e /lfs/h2/emc/ptmp/perry.shafran/output/metplus_priconest.out
#PBS -q "dev"
#PBS -A VERF-DEV
#PBS -S /bin/bash
...
export cycle=t00z
export MET_PLUS_TMP=/lfs/h2/emc/ptmp/perry.shafran/metplus_priconest
...
export MET_PLUS_STD=/lfs/h2/emc/ptmp/perry.shafran/metplus_priconest

mkdir -p $MET_PLUS_STD

export model=priconest
...
[filename_templates]
FCST_POINT_STAT_INPUT_TEMPLATE = nam.{init?fmt=%Y%m%d}/nam.t{init?fmt=%2H}z.priconest.hiresf{lead?fmt=%2H}.tm00.grib2
