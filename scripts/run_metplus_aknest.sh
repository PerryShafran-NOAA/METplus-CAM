#PBS -N metplus_aknest
#PBS -j oe
#PBS -o /lfs/h2/emc/ptmp/perry.shafran/output/metplus_aknest.out
#PBS -e /lfs/h2/emc/ptmp/perry.shafran/output/metplus_aknest.out
#PBS -q "dev"
#PBS -A VERF-DEV
#PBS -S /bin/bash
...
export cycle=t00z
export MET_PLUS_TMP=/lfs/h2/emc/ptmp/perry.shafran/metplus_aknest
...
export MET_PLUS_STD=/lfs/h2/emc/ptmp/perry.shafran/metplus_aknest
...
[filename_templates]
FCST_POINT_STAT_INPUT_TEMPLATE = nam.{init?fmt=%Y%m%d}/nam.t{init?fmt=%2H}z.alaskanest.hiresf{lead?fmt=%2H}.tm00.grib2
