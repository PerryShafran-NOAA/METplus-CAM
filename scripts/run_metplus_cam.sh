...
export MET_PLUS_TMP=/stmpp1/Perry.Shafran/metplus_cam
...
export MET_PLUS_OUT=/meso/noscrub/Perry.Shafran/metplus_cam
export MET_PLUS_STD=/ptmpp1/Perry.Shafran/metplus_cam
...
${MET_PLUS}/ush/master_metplus.py -c ${MET_PLUS}/parm/use_cases/grid_to_obs/grid_to_obs.conf -c ${MET_PLUS}/parm/use_cases/grid_to_obs/examples/conus_surface.conf -c ${MET_PLUS_CONF}/pb2nc_cam.conf -c ${MET_PLUS_CONF}/point_stat_${model}.conf -c ${MET_PLUS_TMP}/shared.conf -c ${MET_PLUS_CONF}/system_cam.conf
...
/meso/save/Perry.Shafran/aws/mv_load_to_aws.sh perry.shafran ${MET_PLUS_TMP}/stat/ /meso/save/Perry.Shafran/aws/load_met_cam.xml

cp /ptmpp2/Perry.Shafran/output/metplus_cam.out $MET_PLUS_STD/metplus_cam_$DATE.out
