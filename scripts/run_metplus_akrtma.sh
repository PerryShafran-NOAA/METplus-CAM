...
#BSUB -J metplus_akrtma
#BSUB -o /gpfs/dell2/ptmp/Perry.Shafran/output/metplus_akrtma.o%J
#BSUB -e /gpfs/dell2/ptmp/Perry.Shafran/output/metplus_akrtma.o%J
#BSUB -q "dev2"
#BSUB -P VERF-T2O
...
export MET_PLUS_TMP=/gpfs/dell2/ptmp/Perry.Shafran/metplus_akrtma
...
export MET_PLUS_STD=/gpfs/dell2/ptmp/Perry.Shafran/metplus_akrtma_${DATE}
...
[filename_templates]
FCST_POINT_STAT_INPUT_TEMPLATE = akrtma.{init?fmt=%Y%m%d}/akrtma.t{init?fmt=%2H}z.2dvaranl_ndfd.grb2
