...
#BSUB -J metplus_akurmages
#BSUB -o /gpfs/dell2/ptmp/Perry.Shafran/output/metplus_akurmages.o%J
#BSUB -e /gpfs/dell2/ptmp/Perry.Shafran/output/metplus_akurmages.o%J
#BSUB -q "dev2"
#BSUB -P VERF-T2O
...
export MET_PLUS_TMP=/gpfs/dell2/ptmp/Perry.Shafran/metplus_akurmages
...
export MET_PLUS_STD=/gpfs/dell2/ptmp/Perry.Shafran/metplus_akurmages_${DATE}

mkdir -p $MET_PLUS_STD

export model=akurmages
...
[filename_templates]
FCST_POINT_STAT_INPUT_TEMPLATE = akurma.{init?fmt=%Y%m%d}/akurma.t{init?fmt=%2H}z.2dvarges_ndfd.grb2
