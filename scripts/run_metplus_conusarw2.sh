#PBS -N metplus_conusarw2
#PBS -j oe
#PBS -o /lfs/h2/emc/ptmp/perry.shafran/output/metplus_conusarw2.out
#PBS -e /lfs/h2/emc/ptmp/perry.shafran/output/metplus_conusarw2.out
#PBS -q "dev"
#PBS -A VERF-DEV
#PBS -S /bin/bash
...
export MET_PLUS_TMP=/lfs/h2/emc/ptmp/perry.shafran/metplus_conusarw2
...
export MET_PLUS_STD=/lfs/h2/emc/ptmp/perry.shafran/metplus_conusarw2
...
MODEL = ${model1}
[filename_templates]
FCST_POINT_STAT_INPUT_TEMPLATE = hiresw.{init?fmt=%Y%m%d}/hiresw.t{init?fmt=%2H}z.arw_5km.f{lead?fmt=%2H}.conusmem2.grib2
