...
#BSUB -J metplus_hinmmb
#BSUB -o /gpfs/dell2/ptmp/Perry.Shafran/output/metplus_hinmmb.out
#BSUB -e /gpfs/dell2/ptmp/Perry.Shafran/output/metplus_hinmmb.out
#BSUB -q "dev"
#BSUB -P VERF-T2O
...
export MET_PLUS_TMP=/gpfs/dell2/ptmp/Perry.Shafran/metplus_hinmmb
...
export MET_PLUS_STD=/gpfs/dell2/ptmp/Perry.Shafran/metplus_hinmmb
...
POINT_STAT_CONFIG_FILE ={PARM_BASE}/met_config/PointStatConfig_cam_hi
LEAD_SEQ = begin_end_incr(0,48,1)
MODEL = ${model1}
POINT_STAT_GRID = G250
[filename_templates]
FCST_POINT_STAT_INPUT_TEMPLATE = hiresw.{init?fmt=%Y%m%d}/hiresw.t{init?fmt=%2H}z.nmmb_5km.f{lead?fmt=%2H}.hi.grib2
POINT_STAT_OUTPUT_TEMPLATE = ${model}
EOF

${MET_PLUS}/ush/master_metplus.py -c ${MET_PLUS}/parm/use_cases/grid_to_obs/grid_to_obs.conf -c ${MET_PLUS}/parm/use_cases/grid_to_obs/examples/conus_surface.conf -c ${MET_PLUS_CONF}/pb2nc_cam_hi.conf -c ${MET_PLUS_CONF}/point_stat_cam.conf -c ${MET_PLUS_TMP}/${model}.conf -c ${MET_PLUS_CONF}/shared.conf -c ${MET_PLUS_TMP}/shared_${model}.conf -c ${MET_PLUS_CONF}/system_cam.conf
...
/gpfs/dell2/emc/verification/save/Perry.Shafran/aws/mv_load_to_aws.sh perry.shafran ${MET_PLUS_TMP}/stat/ ${MET_PLUS_TMP}/load_met_hinmmb.xml

cp /gpfs/dell2/ptmp/Perry.Shafran/output/metplus_hinmmb.out $MET_PLUS_STD/metplus_hinmmb_$DATE.out
