...
#BSUB -J metplus_pcp_conusnest
#BSUB -o /gpfs/dell2/ptmp/Perry.Shafran/output/metplus_pcp_conusnest.out
#BSUB -e /gpfs/dell2/ptmp/Perry.Shafran/output/metplus_pcp_conusnest.out
#BSUB -q "dev"
#BSUB -P VERF-T2O
...
export MET_PLUS_TMP=/gpfs/dell2/ptmp/Perry.Shafran/metplus_pcp_conusnest
...
export MET_PLUS_STD=/gpfs/dell2/ptmp/Perry.Shafran/metplus_pcp_conusnest
...
export model_dir=/gpfs/dell1/nco/ops/com/nam/prod
...
VALID_INCREMENT = 3H
[filename_templates]
FCST_GRID_STAT_INPUT_TEMPLATE = nam.{init?fmt=%Y%m%d}/nam.t{init?fmt=%2H}z.conusnest.hiresf{lead?fmt=%2H}.tm00.grib2
...
FCST_PCP_COMBINE_INPUT_TEMPLATE = nam.{init?fmt=%Y%m%d}/nam.t{init?fmt=%2H}z.conusnest.hiresf{lead?fmt=%2H}.tm00.grib2
FCST_PCP_COMBINE_OUTPUT_TEMPLATE = ${DATE}/conusnest.t{init?fmt=%H}z.conus.f{lead?fmt=%HH}.a{level?fmt=%HH}h
GRID_STAT_OUTPUT_TEMPLATE = grid_stat/${model}
EOF
...
/gpfs/dell2/emc/verification/save/Perry.Shafran/aws/mv_load_to_aws.sh perry.shafran ${MET_PLUS_TMP}/stat/ ${MET_PLUS_TMP}/load_met_conusnest.xml

cp /gpfs/dell2/ptmp/Perry.Shafran/output/metplus_conusnest_pcp.out $MET_PLUS_STD/metplus_conusnest_$DATE.out
