...
#BSUB -J metplus_namna
#BSUB -o /gpfs/dell2/ptmp/Perry.Shafran/output/metplus_namna.out
#BSUB -e /gpfs/dell2/ptmp/Perry.Shafran/output/metplus_namna.out
#BSUB -q "dev"
#BSUB -P VERF-T2O
...
export MET_PLUS_TMP=/gpfs/dell2/ptmp/Perry.Shafran/metplus_namna
...
export MET_PLUS_STD=/gpfs/dell2/ptmp/Perry.Shafran/metplus_namna
