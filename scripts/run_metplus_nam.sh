#PBS -N metplus_nam
#PBS -j oe
#PBS -o /lfs/h2/emc/ptmp/perry.shafran/output/metplus_nam.out
#PBS -e /lfs/h2/emc/ptmp/perry.shafran/output/metplus_nam.out
#PBS -q "dev"
#PBS -A VERF-DEV
#PBS -S /bin/bash
...
export MET_PLUS_TMP=/lfs/h2/emc/ptmp/perry.shafran/metplus_nam
...
export MET_PLUS_STD=/lfs/h2/emc/ptmp/perry.shafran/metplus_nam
