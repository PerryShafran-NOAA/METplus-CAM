...
#BSUB -J metplus_gfsv16
#BSUB -o /gpfs/dell2/ptmp/Perry.Shafran/output/metplus_gfsv16.out
#BSUB -e /gpfs/dell2/ptmp/Perry.Shafran/output/metplus_gfsv16.out
#BSUB -q "dev"
#BSUB -P VERF-T2O
...
export MET_PLUS_TMP=/gpfs/dell2/ptmp/Perry.Shafran/metplus_gfsv16
...
export MET_PLUS_STD=/gpfs/dell2/ptmp/Perry.Shafran/metplus_gfsv16
...
cat << EOF > ${model}.conf
[dir]
FCST_POINT_STAT_INPUT_DIR = /gpfs/dell1/nco/ops/com/gfs/para
...
/gpfs/dell2/emc/verification/save/Perry.Shafran/aws/mv_load_to_aws.sh perry.shafran ${MET_PLUS_TMP}/stat/ ${MET_PLUS_TMP}/load_met_${model}.xml

cp /gpfs/dell2/ptmp/Perry.Shafran/output/metplus_gfsv16.out $MET_PLUS_STD/metplus_gfsv16_$DATE.out
