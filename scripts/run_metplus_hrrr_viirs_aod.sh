#PBS -N metplus_hrrr_aod_viirs
#PBS -j oe
#PBS -o /lfs/h2/emc/ptmp/perry.shafran/output/metplus_hrrr_aod_viirs.out
#PBS -e /lfs/h2/emc/ptmp/perry.shafran/output/metplus_hrrr_aod_viirs.out
#PBS -q "dev"
#PBS -A VERF-DEV
#PBS -S /bin/bash
...
export cycle=t00z
export MET_PLUS_TMP=/lfs/h2/emc/ptmp/perry.shafran/metplus_hrrr_aod_viirs
...
export MET_PLUS_STD=/lfs/h2/emc/ptmp/perry.shafran/metplus_hrrr_aod_viirs_${DATE}
...
mkdir -p /lfs/dell2/emc/vpppg/noscrub/perry.shafran/VIIRS_AOD_HRRR_REGRID/${DATE}
...
run_metplus.py -c ${MET_PLUS_CONF}/grid_stat_hrrr_viirs_aod.conf ${MET_PLUS_TMP}/grid_stat.conf 
