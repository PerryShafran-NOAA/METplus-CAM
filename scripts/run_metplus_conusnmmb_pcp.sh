...
#BSUB -J metplus_pcp_conusnmmb
#BSUB -o /gpfs/dell2/ptmp/Perry.Shafran/output/metplus_pcp_conusnmmb.out
#BSUB -e /gpfs/dell2/ptmp/Perry.Shafran/output/metplus_pcp_conusnmmb.out
#BSUB -q "dev"
#BSUB -P VERF-T2O
...
export MET_PLUS_TMP=/gpfs/dell2/ptmp/Perry.Shafran/metplus_pcp_conusnmmb
...
export MET_PLUS_STD=/gpfs/dell2/ptmp/Perry.Shafran/metplus_pcp_conusnmmb
...
export model_dir=/gpfs/hps/nco/ops/com/hiresw/prod
...
export acc=1hr
export fhr_list="begin_end_incr(1,48,1)"
...
VALID_INCREMENT = 3H
[filename_templates]
FCST_GRID_STAT_INPUT_TEMPLATE = hiresw.{init?fmt=%Y%m%d}/hiresw.t{init?fmt=%2H}z.nmmb_5km.f{lead?fmt=%2H}.conus.grib2
...
FCST_PCP_COMBINE_INPUT_TEMPLATE = hiresw.{init?fmt=%Y%m%d}/hiresw.t{init?fmt=%2H}z.nmmb_5km.f{lead?fmt=%2H}.conus.grib2
FCST_PCP_COMBINE_OUTPUT_TEMPLATE = ${DATE}/conusnmmb.t{init?fmt=%H}z.conus.f{lead?fmt=%HH}.a{level?fmt=%HH}h
GRID_STAT_OUTPUT_TEMPLATE = grid_stat/${model}
EOF
...
<load_spec>
  <connection>
    ...
    <database>mv_cam_pcp_2021_metplus</database>
    <user>rds_user</user>
  ...
  <description>Loading of EMC CAM precip</description>
...
/gpfs/dell2/emc/verification/save/Perry.Shafran/aws/mv_load_to_aws.sh perry.shafran ${MET_PLUS_TMP}/stat/ ${MET_PLUS_TMP}/load_met_conusnmmb.xml

cp /gpfs/dell2/ptmp/Perry.Shafran/output/metplus_conusnmmb_pcp.out $MET_PLUS_STD/metplus_conusnmmb_$DATE.out
