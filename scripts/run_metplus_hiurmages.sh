...
#BSUB -J metplus_hiurmages
#BSUB -o /gpfs/dell2/ptmp/Perry.Shafran/output/metplus_hiurmages.o%J
#BSUB -e /gpfs/dell2/ptmp/Perry.Shafran/output/metplus_hiurmages.o%J
#BSUB -q "dev2"
#BSUB -P VERF-T2O
...
export MET_PLUS_TMP=/gpfs/dell2/ptmp/Perry.Shafran/metplus_hiurmages
...
export MET_PLUS_STD=/gpfs/dell2/ptmp/Perry.Shafran/metplus_hiurmages_${DATE}

mkdir -p $MET_PLUS_STD

export model=hiurmages
...
cat << EOF > ${model}.conf
[dir]
FCST_POINT_STAT_INPUT_DIR = /gpfs/dell2/nco/ops/com/urma/prod
...
[filename_templates]
FCST_POINT_STAT_INPUT_TEMPLATE = hiurma.{init?fmt=%Y%m%d}/hiurma.t{init?fmt=%2H}z.2dvarges_ndfd.grb2
