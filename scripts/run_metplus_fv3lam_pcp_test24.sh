...
export temp=/gpfs/dell2/ptmp/Perry.Shafran/fv3lamtest_date
...
export MET_PLUS_TMP=/gpfs/dell2/ptmp/Perry.Shafran/metplus_pcp_fv3lamtest_$DATE
...
export MET_PLUS_STD=/gpfs/dell2/ptmp/Perry.Shafran/metplus_pcp_fv3lamtest_$DATE
...
export acc=1hr
export fhr_list="begin_end_incr(24,60,6)"
...
<load_spec>
  <connection>
    ...
    <database>mv_lam_pcp_metplus</database>
    <user>rds_user</user>
...
cp /gpfs/dell2/ptmp/Perry.Shafran/output/metplus_fv3lamtest_pcp.out $MET_PLUS_STD/metplus_fv3lamtest_$DATE.out
