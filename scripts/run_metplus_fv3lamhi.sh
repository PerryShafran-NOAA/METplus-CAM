...
#BSUB -J metplus_fv3lamhi
#BSUB -o /gpfs/dell2/ptmp/Perry.Shafran/output/metplus_fv3lamhi.out
#BSUB -e /gpfs/dell2/ptmp/Perry.Shafran/output/metplus_fv3lamhi.out
#BSUB -q "dev"
#BSUB -P VERF-T2O
...
export MET_PLUS_TMP=/gpfs/dell2/ptmp/Perry.Shafran/metplus_fv3lamhi
...
export MET_PLUS_STD=/gpfs/dell2/ptmp/Perry.Shafran/metplus_fv3lamhi_$DATE

mkdir -p $MET_PLUS_STD

export model=fv3lamhi
...
[filename_templates]
FCST_POINT_STAT_INPUT_TEMPLATE = fv3lam.{init?fmt=%Y%m%d}/{init?fmt=%2H}/fv3lam.t{init?fmt=%2H}z.hi.f{lead?fmt=%2H}.grib2
