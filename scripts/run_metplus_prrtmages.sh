...
#BSUB -J metplus_prrtmages
#BSUB -o /gpfs/dell2/ptmp/Perry.Shafran/output/metplus_prrtmages.o%J
#BSUB -e /gpfs/dell2/ptmp/Perry.Shafran/output/metplus_prrtmages.o%J
#BSUB -q "dev2"
#BSUB -P VERF-T2O
...
export MET_PLUS_TMP=/gpfs/dell2/ptmp/Perry.Shafran/metplus_prrtmages
...
export MET_PLUS_STD=/gpfs/dell2/ptmp/Perry.Shafran/metplus_prrtmages_${DATE}

mkdir -p $MET_PLUS_STD

export model=prrtmages
...
[filename_templates]
FCST_POINT_STAT_INPUT_TEMPLATE = prrtma.{init?fmt=%Y%m%d}/prrtma.t{init?fmt=%2H}z.2dvarges_ndfd.grb2
