...
#BSUB -J metplus_fv3lampr
#BSUB -o /gpfs/dell2/ptmp/Perry.Shafran/output/metplus_fv3lampr.out
#BSUB -e /gpfs/dell2/ptmp/Perry.Shafran/output/metplus_fv3lampr.out
#BSUB -q "dev"
#BSUB -P VERF-T2O
...
export MET_PLUS_TMP=/gpfs/dell2/ptmp/Perry.Shafran/metplus_fv3lampr
...
export MET_PLUS_STD=/gpfs/dell2/ptmp/Perry.Shafran/metplus_fv3lampr_$DATE

mkdir -p $MET_PLUS_STD

export model=fv3lampr
...
[filename_templates]
FCST_POINT_STAT_INPUT_TEMPLATE = fv3lam.{init?fmt=%Y%m%d}/{init?fmt=%2H}/fv3lam.t{init?fmt=%2H}z.pr.f{lead?fmt=%2H}.grib2
