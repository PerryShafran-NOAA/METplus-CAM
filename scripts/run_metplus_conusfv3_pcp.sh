...
#BSUB -J metplus_pcp_conusfv3
#BSUB -o /gpfs/dell2/ptmp/Perry.Shafran/output/metplus_pcp_conusfv3.out
#BSUB -e /gpfs/dell2/ptmp/Perry.Shafran/output/metplus_pcp_conusfv3.out
#BSUB -q "dev"
#BSUB -P VERF-T2O
...
export MET_PLUS_TMP=/gpfs/dell2/ptmp/Perry.Shafran/metplus_pcp_conusfv3
...
export MET_PLUS_STD=/gpfs/dell2/ptmp/Perry.Shafran/metplus_pcp_conusfv3
...
export acc=1hr
export fhr_list="begin_end_incr(0,48,1)"
...
VALID_INCREMENT = 3H
[filename_templates]
FCST_GRID_STAT_INPUT_TEMPLATE = hiresw.{init?fmt=%Y%m%d}/hiresw.t{init?fmt=%2H}z.fv3_5km.f{lead?fmt=%2H}.conus.grib2
...
FCST_PCP_COMBINE_INPUT_TEMPLATE = hiresw.{init?fmt=%Y%m%d}/hiresw.t{init?fmt=%2H}z.fv3_5km.f{lead?fmt=%2H}.conus.grib2
FCST_PCP_COMBINE_OUTPUT_TEMPLATE = ${DATE}/conusfv3.t{init?fmt=%H}z.conus.f{lead?fmt=%HH}.a{level?fmt=%HH}h
GRID_STAT_OUTPUT_TEMPLATE = grid_stat/${model}
EOF
...
/gpfs/dell2/emc/verification/save/Perry.Shafran/aws/mv_load_to_aws.sh perry.shafran ${MET_PLUS_TMP}/stat/ ${MET_PLUS_TMP}/load_met_conusfv3.xml

cp /gpfs/dell2/ptmp/Perry.Shafran/output/metplus_conusfv3_pcp.out $MET_PLUS_STD/metplus_conusfv3_$DATE.out
