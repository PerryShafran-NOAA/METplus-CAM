...
#BSUB -J metplus_fv3lam
#BSUB -o /gpfs/dell2/ptmp/Perry.Shafran/output/metplus_fv3lam.out
#BSUB -e /gpfs/dell2/ptmp/Perry.Shafran/output/metplus_fv3lam.out
#BSUB -q "dev"
#BSUB -P VERF-T2O
...
export MET_PLUS_TMP=/gpfs/dell2/ptmp/Perry.Shafran/metplus_fv3lam
...
export MET_PLUS_STD=/gpfs/dell2/ptmp/Perry.Shafran/metplus_fv3lam
...
[filename_templates]
FCST_POINT_STAT_INPUT_TEMPLATE = fv3lam.{init?fmt=%Y%m%d}/{init?fmt=%2H}/fv3lam.t{init?fmt=%2H}z.conus.f{lead?fmt=%2H}.grib2
...
cp /gpfs/dell2/ptmp/Perry.Shafran/output/metplus_fv3lam.out $MET_PLUS_STD/metplus_fv3lam_$DATE.out
