...
#BSUB -J metplus_pcp_fv3lamx
#BSUB -o /gpfs/dell2/ptmp/Perry.Shafran/output/metplus_pcp_fv3lamx.out
#BSUB -e /gpfs/dell2/ptmp/Perry.Shafran/output/metplus_pcp_fv3lamx.out
#BSUB -q "dev"
#BSUB -P VERF-T2O
...
export temp=/gpfs/dell2/ptmp/Perry.Shafran/fv3lamx_date
...
export MET_PLUS_TMP=/gpfs/dell2/ptmp/Perry.Shafran/metplus_pcp_fv3lamx_$DATE
...
export MET_PLUS_STD=/gpfs/dell2/ptmp/Perry.Shafran/metplus_pcp_fv3lamx_$DATE
...
export model_dir=/gpfs/dell6/ptmp/emc.campara/fv3lamx
...
VALID_INCREMENT = 3H
[filename_templates]
FCST_GRID_STAT_INPUT_TEMPLATE = fv3lamx.{init?fmt=%Y%m%d}/{init?fmt=%2H}/fv3lam.t{init?fmt=%2H}z.conus.f{lead?fmt=%2H}.grib2
...
VALID_INCREMENT = 3H
[filename_templates]
FCST_PCP_COMBINE_INPUT_TEMPLATE = fv3lamx.{init?fmt=%Y%m%d}/{init?fmt=%2H}/fv3lam.t{init?fmt=%2H}z.conus.f{lead?fmt=%2H}.grib2
FCST_PCP_COMBINE_OUTPUT_TEMPLATE = ${DATE}/fv3lamx.t{init?fmt=%H}z.conus.f{lead?fmt=%HH}.a{level?fmt=%HH}h
GRID_STAT_OUTPUT_TEMPLATE = grid_stat/${model}
EOF
...
cp /gpfs/dell2/ptmp/Perry.Shafran/output/metplus_fv3lamx_pcp.out $MET_PLUS_STD/metplus_fv3lamx_$DATE.out
